<div class="Box-body px-5 pb-5">
        <article class="markdown-body entry-content container-lg" itemprop="text"><h1 align="center">
        <a id="user-content-----" class="anchor" aria-hidden="true" href="#----">
          <h2>FIND PLACES</h2>
    </a>
</h1>
<p align="center">
  <a href="#rocket-tecnologias">Tecnologias e Recursos</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
...
<br>
<p align="center">
  <img alt="CodeFlix" src="https://github.com/luizbragasouza/FindPlaces/blob/main/FULLPAGE.PNG?raw=true" width="100%" style="max-width:100%;"></a>
          <img alt="CodeFlix" src="https://github.com/luizbragasouza/FindPlaces/blob/main/DETAILS.PNG?raw=true" width="100%" style="max-width:100%;"></a>
</p>
<h2><a id="user-content--tecnologias" class="anchor" aria-hidden="true" href="#-tecnologias"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path></svg></a><g-emoji class="g-emoji" alias="rocket" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f680.png"><img class="emoji" alt="rocket" height="20" width="20" src="https://github.githubassets.com/images/icons/emoji/unicode/1f680.png"></g-emoji> Tecnologias e Recursos</h2>
<p>Esse projeto foi desenvolvido com as seguintes tecnologias:</p>
<ul>
<li><a href="https://www.json.org/json-en.html" rel="nofollow">JSON</a></li>
...
<li><a href="https://developers.google.com/maps/documentation/javascript/overview" rel="nofollow">Google Maps Api</a></li>
</ul>
<h2><a id="user-content--projeto" class="anchor" aria-hidden="true" href="#-projeto">
...
<p>Durante o desenvolvimento de uma aplicação para encontrar restaurantes (restaurante Finder) feito no bootcamp da LOCALIZA - Digital Innovation One, criei o Find Places. </p>
<p>O Find Places é uma ferramenta para encontrar próximo da sua localização lugares relevantes ao nosso dia a dia, como bancos, farmácias, postos de combustíveis, etc.</p>
...
<hr>
<p>Feito no BootCamp LOCALIZA - Digital Innovation One 
